...
!["dominating_sets_example2"](/_images/hispic1.jpg){:height="10%" width="10%"} -->
<center><h1> <span style="color:blue">here is the truth table of logic gates </span></h1></center><br/>
<table align ="center" style="margin: 0px auto;" class="wikirable">
...
* these sites ([1](https://www.tutorialspoint.com/computer_logical_organization/logic_gates.htm)---[2](https://www.khanacademy.org/computing/ap-computer-science-principles/computers-101/logic-gates-and-circuits/a/logic-gates)---[3](https://logic.ly/lessons/)---[4](https://www.geeksforgeeks.org/introduction-of-logic-gates/)---[5 this is video](https://www.youtube.com/watch?v=lXWpWNKwYbo))perhaps help you to get a total imagination about logic gates
* i think [wikipedia](https://en.wikipedia.org/wiki/Logic_gate) has explained well with understandable table
